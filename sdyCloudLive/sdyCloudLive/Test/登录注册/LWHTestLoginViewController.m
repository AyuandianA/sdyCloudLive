...
@interface LWHTestLoginViewController ()<UITextFieldDelegate>
...
@implementation LWHTestLoginViewController
...
{
    LWHTestSignInViewController *signIn = [[LWHTestSignInViewController alloc]init];
