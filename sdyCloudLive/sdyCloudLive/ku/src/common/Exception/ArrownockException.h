...
typedef enum : NSInteger {
    ...
    IM_FAILED_ADD_BLACKLIST             = 2119,
    IM_FAILED_REMOVE_BLACKLIST          = 2120,
    IM_FAILED_LIST_BLACKLISTS           = 2121,
    ...
    DESK_INVALID_ANIM                   = -300000,
    DESK_INVALID_USER                   = -300001,
    DESK_INVALID_USER_ID                = -300002,
    DESK_INVALID_USER_NAME              = -300003,
    DESK_INVALID_USER_AGE               = -300004,
    DESK_INVALID_GROUP_ID               = -300005,
    DESK_INVALID_CLIENT_ID              = -300006,
    DESK_INVALID_SESSION_ID             = -300007,
    DESK_INVALID_MESSAGE                = -300008,
    DESK_INVALID_DATA                   = -300009,
    
    GROUPEDIA_INVALID_ANIM              = -400000,
    GROUPEDIA_INVALID_ID                = -400001,
    GROUPEDIA_INVALID_PAGE_OR_LIMIT     = -400002,
    GROUPEDIA_INVALID_CONTENT           = -400003,
    GROUPEDIA_INVALID_MESSAGE           = -400004,
    GROUPEDIA_INVALID_DATA              = -400005,
    GROUPEDIA_INVALID_NAME_AVATAR       = -400006
