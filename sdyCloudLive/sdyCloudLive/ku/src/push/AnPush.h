...
@optional
- (void) didRecievedNotifications:(NSDictionary *)notifications;
...
+ (void)registerForPushNotification:(UIRemoteNotificationType)types  __attribute__((deprecated("Use registerForPushNotification instead.")));
