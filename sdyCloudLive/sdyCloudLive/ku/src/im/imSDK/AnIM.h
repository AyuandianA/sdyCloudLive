...
- (void)anIM:(AnIM *)anIM messageReceived:(NSString *)messageId from:(NSString *)from __attribute__((deprecated("Use messageReceived:messageId from type instead.")));
;
- (void)anIM:(AnIM *)anIM messageRead:(NSString *)messageId from:(NSString *)from __attribute__((deprecated("Use messageReceived:messageId from type instead.")));
;
- (void)anIM:(AnIM *)anIM messageReceived:(NSString *)messageId from:(NSString *)from type:(NSString *)fromType;
- (void)anIM:(AnIM *)anIM messageRead:(NSString *)messageId from:(NSString *)from type:(NSString *)fromType;
- (void)anIM:(AnIM *)anIM messageSentFromOtherDevice:(AnIMMessage *)message;
...
- (void)anIM:(AnIM *)anIM didReceiveCreateTopicEvent:(NSString *)eventId from:(NSString *)from topicId:(NSString *)topicId owner:(NSString *)owner name:(NSString *)topicName parties:(NSSet *)parties at:(NSNumber *)timestamp customData:(NSDictionary *)customData;
- (void)anIM:(AnIM *)anIM didReceiveUpdateTopicEvent:(NSString *)eventId from:(NSString *)from topicId:(NSString *)topicId owner:(NSString *)owner name:(NSString *)topicName at:(NSNumber *)timestamp customData:(NSDictionary *)customData;
- (void)anIM:(AnIM *)anIM didReceiveAddClientsToTopicEvent:(NSString *)eventId from:(NSString *)from topicId:(NSString *)topicId parties:(NSSet *)parties at:(NSNumber *)timestamp customData:(NSDictionary *)customData;
- (void)anIM:(AnIM *)anIM didReceiveRemoveClientsFromTopicEvent:(NSString *)eventId from:(NSString *)from topicId:(NSString *)topicId parties:(NSSet *)parties at:(NSNumber *)timestamp customData:(NSDictionary *)customData;
- (void)anIM:(AnIM *)anIM didReceiveRemoveTopicEvent:(NSString *)eventId from:(NSString *)from topicId:(NSString *)topicId at:(NSNumber *)timestamp customData:(NSDictionary *)customData;
