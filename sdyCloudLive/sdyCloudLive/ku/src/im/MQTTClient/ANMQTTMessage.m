                   ...
                   protocolLevel:(UInt8)protocolLevel
{
    ...
    ANMQTTMessage *msg = [[ANMQTTMessage alloc] initWithType:ANMQTTConnect
                                                    data:data];
    return msg;
}
...
+ (id)pingreqMessage
{
    return [[ANMQTTMessage alloc] initWithType:ANMQTTPingreq];
}

+ (id)disconnectMessage
{
    return [[ANMQTTMessage alloc] initWithType:ANMQTTDisconnect];
}
                              ...
                              topics:(NSDictionary *)topics
{
    ...
    ANMQTTMessage* msg = [[ANMQTTMessage alloc] initWithType:ANMQTTSubscribe
                                                     qos:1
                                                    data:data];
    msg.mid = msgId;
    return msg;
                                ...
                                topics:(NSArray *)topics
{
    ...
    ANMQTTMessage* msg = [[ANMQTTMessage alloc] initWithType:ANMQTTUnsubscribe
                                                     qos:1
                                                    data:data];
    msg.mid = msgId;
    return msg;
                     ...
                     dupFlag:(BOOL)dup
{
    ...
    ANMQTTMessage *msg = [[ANMQTTMessage alloc] initWithType:ANMQTTPublish
                                                     qos:qosLevel
                                              retainFlag:retain
                                                 dupFlag:dup
                                                    data:data];
...
+ (id)pubackMessageWithMessageId:(UInt16)msgId
{
    NSMutableData* data = [NSMutableData data];
    [data appendUInt16BigEndian:msgId];
    ANMQTTMessage *msg = [[ANMQTTMessage alloc] initWithType:ANMQTTPuback
                                                    data:data];
    msg.mid = msgId;
    return msg;
}
...
+ (id)pubrecMessageWithMessageId:(UInt16)msgId
{
    NSMutableData* data = [NSMutableData data];
    [data appendUInt16BigEndian:msgId];
    ANMQTTMessage *msg = [[ANMQTTMessage alloc] initWithType:ANMQTTPubrec
                                                    data:data];
    msg.mid = msgId;
    return msg;
}
...
+ (id)pubrelMessageWithMessageId:(UInt16)msgId
{
    NSMutableData* data = [NSMutableData data];
    [data appendUInt16BigEndian:msgId];
    ANMQTTMessage *msg = [[ANMQTTMessage alloc] initWithType:ANMQTTPubrel
                                                     qos:1
                                                    data:data];
    msg.mid = msgId;
    return msg;
...
+ (id)pubcompMessageWithMessageId:(UInt16)msgId
{
    NSMutableData* data = [NSMutableData data];
    [data appendUInt16BigEndian:msgId];
    ANMQTTMessage *msg = [[ANMQTTMessage alloc] initWithType:ANMQTTPubcomp
                                                    data:data];
    msg.mid = msgId;
    return msg;
}
