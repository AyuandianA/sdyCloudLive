 ...
 */
@protocol ANMQTTSessionManagerDelegate <NSObject>

/**
 Enumeration of MQTTSessionManagerState values
 */
typedef NS_ENUM(int, ANMQTTSessionManagerState) {
    ANMQTTSessionManagerStateStarting,
    ANMQTTSessionManagerStateConnecting,
    ANMQTTSessionManagerStateError,
    ANMQTTSessionManagerStateConnected,
    ANMQTTSessionManagerStateClosing,
    ANMQTTSessionManagerStateClosed
};
 ...
 */
@interface ANMQTTSessionManager : NSObject <ANMQTTSessionDelegate>

/** the delegate receiving incoming messages
 */
@property (weak, nonatomic) id<ANMQTTSessionManagerDelegate> delegate;
 ...
 */
@property (nonatomic, readonly) ANMQTTSessionManagerState state;
