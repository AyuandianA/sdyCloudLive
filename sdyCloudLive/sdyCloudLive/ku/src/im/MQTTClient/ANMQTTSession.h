...
@protocol ANMQTTSessionDelegate <NSObject>

/**
 Enumeration of MQTTSession states
 */
typedef NS_ENUM(NSInteger, ANMQTTSessionStatus) {
    ANMQTTSessionStatusInit,
    ANMQTTSessionStatusCreated,
    ANMQTTSessionStatusConnecting,
    ANMQTTSessionStatusConnected,
    ANMQTTSessionStatusDisconnecting,
    ANMQTTSessionStatusClosed,
    ANMQTTSessionStatusError
};

/**
 Enumeration of MQTTSession events
 */
typedef NS_ENUM(NSInteger, ANMQTTSessionEvent) {
    ANMQTTSessionEventConnected,
    ANMQTTSessionEventConnectionRefused,
    ANMQTTSessionEventConnectionClosed,
    ANMQTTSessionEventConnectionError,
    ANMQTTSessionEventProtocolError,
    ANMQTTSessionEventConnectionClosedByBroker
};
 ...
 */
- (void)newMessage:(ANMQTTSession *)session
              data:(NSData *)data
 ...
 */
- (void)session:(ANMQTTSession*)session newMessage:(NSData*)data onTopic:(NSString*)topic;
 ...
 */
- (void)messageDelivered:(ANMQTTSession *)session msgID:(UInt16)msgID;
 ...
 */
- (void)unsubAckReceived:(ANMQTTSession *)session msgID:(UInt16)msgID;
 ...
 */
- (void)sending:(ANMQTTSession *)session type:(int)type qos:(ANMQTTQosLevel)qos retained:(BOOL)retained duped:(BOOL)duped mid:(UInt16)mid data:(NSData *)data;
...
/** gets called when a command is received from the MQTT broker
 ...
 @param data the payload data of the command if any, might be zero length
 */
- (void)received:(ANMQTTSession *)session type:(int)type qos:(ANMQTTQosLevel)qos retained:(BOOL)retained duped:(BOOL)duped mid:(UInt16)mid data:(NSData *)data;
 ...
 */
- (BOOL)ignoreReceived:(ANMQTTSession *)session type:(int)type qos:(ANMQTTQosLevel)qos retained:(BOOL)retained duped:(BOOL)duped mid:(UInt16)mid data:(NSData *)data;
 ...
 */
- (void)buffered:(ANMQTTSession *)session
...
@interface ANMQTTSession : NSObject
...
@property (weak, nonatomic) id<ANMQTTSessionDelegate> delegate;
...
*/
@property (strong, nonatomic) ANMQTTPersistence *persistence;

/** for mqttio-OBJC backward compatibility */
@property (strong) void (^connectionHandler)(ANMQTTSessionEvent event);
/** for mqttio-OBJC backward compatibility */
@property (strong) void (^messageHandler)(NSData* message, NSString* topic);

/** Session status
 */
@property (nonatomic, readonly) ANMQTTSessionStatus status;
...
/** see initWithClientId for description
 */
@property (nonatomic) ANMQTTQosLevel willQoS;
/** see initWithClientId for description
 */
...
*/
@property (strong, nonatomic) ANMQTTSSLSecurityPolicy *securityPolicy;
 ...
 */
@property (strong, nonatomic) ANMQTTMessage *connectMessage;
...
- (void)connectToHost:(NSString*)ip
                 port:(UInt32)port
withConnectionHandler:(void (^)(ANMQTTSessionEvent event))connHandler
...
- (UInt16)subscribeToTopic:(NSString *)topic atLevel:(ANMQTTQosLevel)qosLevel;
...
- (UInt16)publishData:(NSData *)data onTopic:(NSString *)topic retain:(BOOL)retainFlag qos:(ANMQTTQosLevel)qos;

- (UInt16)publishData:(NSData *)data onTopic:(NSString *)topic retain:(BOOL)retainFlag qos:(ANMQTTQosLevel)qos messageId:(NSString *)messageId;
...
- (BOOL)publishAndWaitData:(NSData *)data onTopic:(NSString *)topic retain:(BOOL)retainFlag qos:(ANMQTTQosLevel)qos;
