...
@interface ANMQTTMessage : NSObject
...
typedef NS_ENUM(UInt8, ANMQTTCommandType) {
    ANMQTTConnect = 1,
    ANMQTTConnack = 2,
    ANMQTTPublish = 3,
    ANMQTTPuback = 4,
 ...
 */
typedef NS_ENUM(UInt8, ANMQTTQosLevel) {
    ANMQTTQosLevelAtMostOnce = 0,
    ANMQTTQosLevelAtLeastOnce,
    ANMQTTQosLevelExactlyOnce
};
